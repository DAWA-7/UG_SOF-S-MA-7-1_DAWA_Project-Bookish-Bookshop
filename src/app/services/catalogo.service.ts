...
export class CatalogoService {
  ...
  libros: Book[] = [
    ...
    num_paginas: 464, isbn: "9788408230496", descripcion: "Tras un paréntesis en Rusia, para Sofia ha llegado el momento de poner orden a su vida sentimental. Ya no puede seguir huyendo de su pasado, de la soledad de su matrimonio, ni de la historia pasional y rota con Tancredi, y decide regresar a Roma. En un viaje a Sicilia para visitar a sus padres, descubrirá un secreto familiar que le afectará profundamente. Mientras tanto, Tancredi sigue todos sus pasos; es un hombre enamorado que nunca se ha rendido a la primera. Pero Sofía no confía en él… ¿Acabarán reencontrándose?", 
    titulo: "Mil noches sin ti", precio: 9.59, imagen: "MilNochesSinTi.webp"},
    {id_libro: 2, autor: "Juan Carlos Florez", editorial: "Ariel", id_categoria: 0/*Histórica*/, fecha_publicacion: new Date(24/5/2021),
    num_paginas: 356, isbn: "9789584294647", descripcion: "Un análisis profundo, sobre el estado actual de la sociedad humana. Un libro que nos incita a cambiar lo que ahora tenemos, y, desde nosotros mismos, empezar a realizar la verdadera revolución pacífica."+
    ...
    titulo: "Una Herencia En Juego", precio: 17.35, imagen: "UnaHerenciaEnJuego.webp"},
    {id_libro: 5, autor: "Megan Maxwell", editorial: "Esencia", id_categoria: 0/*Romance*/, fecha_publicacion: new Date(29/10/2020),
    num_paginas: 672, isbn: "9788408233350", descripcion: "Can Drogo, piloto e hijo del dueño de la empresa aeronáutica High Drogo, es un hombre alto, guapo, adinerado, simpático… Puede elegir a la mujer que desee, y aunque disfruta de esa «magia especial» con la que le ha dotado la vida, en su interior siente que todas lo aburren."+
